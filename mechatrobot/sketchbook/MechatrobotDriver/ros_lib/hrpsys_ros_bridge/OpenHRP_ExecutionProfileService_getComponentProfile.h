...
static const char OPENHRP_EXECUTIONPROFILESERVICE_GETCOMPONENTPROFILE[] = "hrpsys_ros_bridge/OpenHRP_ExecutionProfileService_getComponentProfile";
  ...
  {
    public:
      typedef hrpsys_ros_bridge::RTC_LightweightRTObject _obj_type;
      _obj_type obj;
  ...
  {
    public:
      typedef hrpsys_ros_bridge::OpenHRP_ExecutionProfileService_ComponentProfile _operation_return_type;
