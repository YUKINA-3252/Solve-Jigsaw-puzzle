...
namespace hrpsys_ros_bridge
{
  ...
  {
    public:
      typedef float _default_recover_time_type;
      _default_recover_time_type default_recover_time;
      typedef float _default_retrieve_time_type;
      _default_retrieve_time_type default_retrieve_time;
      typedef bool _is_stop_mode_type;
      _is_stop_mode_type is_stop_mode;
