...
namespace hrpsys_ros_bridge
{
  ...
  {
    public:
      typedef float _Q_angle_type;
      _Q_angle_type Q_angle;
      typedef float _Q_rate_type;
      _Q_rate_type Q_rate;
      typedef float _R_angle_type;
      _R_angle_type R_angle;
      typedef int64_t _kf_algorithm_type;
      _kf_algorithm_type kf_algorithm;
      float acc_offset[3];
