...
static const char OPENHRP_FORWARDKINEMATICSSERVICE_GETCURRENTPOSE[] = "hrpsys_ros_bridge/OpenHRP_ForwardKinematicsService_getCurrentPose";
  ...
  {
    public:
      typedef const char* _linkname_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      varToArr(outbuffer + offset, length_linkname);
      offset += 4;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      arrToVar(length_linkname, (inbuffer + offset));
      offset += 4;
  ...
  class OpenHRP_ForwardKinematicsService_getCurrentPoseResponse : public ros::Msg
  {
    public:
      ...
      typedef hrpsys_ros_bridge::RTC_TimedDoubleSeq _pose_type;
      _pose_type pose;
