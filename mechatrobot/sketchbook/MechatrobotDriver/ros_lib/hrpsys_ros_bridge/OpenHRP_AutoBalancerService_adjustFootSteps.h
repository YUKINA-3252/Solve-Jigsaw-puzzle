...
static const char OPENHRP_AUTOBALANCERSERVICE_ADJUSTFOOTSTEPS[] = "hrpsys_ros_bridge/OpenHRP_AutoBalancerService_adjustFootSteps";
  ...
  {
    public:
      typedef hrpsys_ros_bridge::OpenHRP_AutoBalancerService_Footstep _rfootstep_type;
      _rfootstep_type rfootstep;
      typedef hrpsys_ros_bridge::OpenHRP_AutoBalancerService_Footstep _lfootstep_type;
      _lfootstep_type lfootstep;
